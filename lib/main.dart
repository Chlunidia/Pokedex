      ...
      home: Scaffold(
        ...
        body: ListView(
          children: const <Widget>[
            ...
            Pokedex(number: '#003 ', dinosaur: 'Venusaur ', category: 'Seed ', image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/003.png', type1: 'G', type2: 'Grass', type3: 'P', type4: 'Poison', weaknesses1: 'F', weaknesses2: 'Fire', weaknesses3: 'P', weaknesses4: 'Poison', weaknesses5: 'F', weaknesses6: 'Flying', weaknesses7: 'I', weaknesses8: 'Ice', heightwight: 'Height 6.07 Weight 220.5', description: 'Its plant blooms when it is absorbing solar energy. It stays on the move to seek sunlight.', hp: '5', speed: '5', specialattack: '6', attack: '5', defense: '5', specialdefense: '5', color: Color.fromARGB(199, 170, 203, 255)),
          ],
        ),
      ),
    );
